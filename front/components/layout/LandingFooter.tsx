...
export default function LandingFooter() {
  return (
    <footer className="w-full py-2xl bg-surface-container-low dark:bg-surface-dim border-t border-outline-variant">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-lg px-lg max-w-container-max mx-auto">
        ...
        <div className="space-y-sm">
          ...
          <ul className="space-y-2 font-body-sm text-body-sm">
            <li className=""><a className="text-on-surface-variant hover:text-primary transition-all hover:underline" href="#features">Features</a></li>
          </ul>
        </div>
        <div className="space-y-sm">
          ...
          <ul className="space-y-2 font-body-sm text-body-sm">
            ...
            <li className=""><a className="text-on-surface-variant hover:text-primary transition-all hover:underline" target="_blank" rel="noopener noreferrer" href="https://mail.google.com/mail/?view=cm&to=internmatch.project@gmail.com">Contact Us</a></li>
          </ul>
        </div>
      </div>
    </footer>
